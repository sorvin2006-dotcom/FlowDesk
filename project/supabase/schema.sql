-- ============================================================
--  FlowDesk — полная схема базы данных
--  Выполните этот файл ОДИН РАЗ в SQL Editor вашего проекта Supabase
...
-- Профили: пользователь видит/меняет только свой профиль
...
-- Service role имеет полный доступ к профилям (для edge functions)
...
-- ============================================================
--  Cron: ежедневная проверка истёкших подписок (00:05 UTC)
-- ============================================================
